...
# 获取固定年份文件夹下的因子数据，并将变量与收益分别保存为三维数组X，二维数组Y
def read_virable_data(year: int):
    ...
    # 假设您有488个DataFrame数据集的列表，存储在 dataframes 中
    # 每个DataFrame具有80列因子数据和244行交易日数据
    # 创建一个空的三维数组，维度为 (244交易日数, 488样本数, 84变量数)
